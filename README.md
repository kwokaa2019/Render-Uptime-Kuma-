Render是一個統一的雲，用於使用免費的TLS 證書、全球CDN、DDoS 保護、專用網絡和從Git 自動部署來構建和運行您的所有應用程序和網站。個人的話適用於業餘愛好者、學生和獨立黑客。每個用戶$0月，妥妥白嫖。每个月免费带宽100 GB 每个月免费时长750小时 每个月免费构建分钟数500/月需要注意的是，如果你想要白嫖一個賬號只能跑一個項目(750小時大約等於31.25天)
